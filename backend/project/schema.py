...
class Query(
    ...
    documentation.schema.Query,
    historyevent.schema.Query,
    supplier.schema.Query,
    localisation.schema.BatimentQuery,
    graphene.ObjectType
):
    pass
...
class Mutation(
    ...
    team.schema.Mutation,
    documentation.schema.Mutation,
    historyevent.schema.Mutation,
    profiles.schema.Mutation,
    localisation.schema.BatimentMutation,
    graphene.ObjectType
):
    pass
