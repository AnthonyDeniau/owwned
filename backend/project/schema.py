...
class Query(organization.schema.Query, team.schema.Query, asset.schema.Query,
            profiles.schema.Query, documentation.schema.Query, historyevent.schema.Query,
            location.schema.Query, supplier.schema.Query, graphene.ObjectType):
    pass


class Mutation(supplier.schema.Mutation, team.schema.Mutation, documentation.schema.Mutation,
               historyevent.schema.Mutation, profiles.schema.Mutation, location.schema.Mutation, graphene.ObjectType):
    pass
