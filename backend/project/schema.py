...
class Mutation(location.schema.Mutation, supplier.schema.Mutation, team.schema.Mutation, documentation.schema.Mutation,
               historyevent.schema.Mutation, profiles.schema.Mutation, graphene.ObjectType):
    pass
